...
class OpenIDLoginHandler extends Handler
{
     ...
     */
    public function legacyLogin(array $args, Request $request)
    {
        $templateMgr = TemplateManager::getManager($request);
     ...
     */
    public function register(array $args, Request $request)
    {
     ...
     */
    public function signOut(array $args, Request $request)
    {
        if (!Validation::isLoggedIn()) {
