...
class OpenIDStep2Form extends Form
{
     ...
     */
    public function __construct(private OpenIDPlugin $plugin, private ?string $selectedProvider = null, private ?UserClaims $claims = null)
    {
        ...
        if ($register) {
            ...
            $this->addCheck(
                new FormValidatorCustom(
                    ...
                    'username',
                    'required',
                    'plugins.generic.openid.form.error.usernameExists',
                    function ($username) {
            ...
            $this->addCheck(
                new FormValidatorCustom(
                    ...
                    'email',
                    'required',
                    'plugins.generic.openid.form.error.emailExists',
                    function ($email) {
