...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public const DEFAULT_CACHE_LIMIT = 1000;
    public const ENV_ENABLED = 'AWS_ENDPOINT_DISCOVERY_ENABLED';
    public const ENV_ENABLED_ALT = 'AWS_ENABLE_ENDPOINT_DISCOVERY';
