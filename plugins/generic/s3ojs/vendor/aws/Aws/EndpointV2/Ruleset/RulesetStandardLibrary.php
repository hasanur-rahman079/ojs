...
{
    public const IPV4_RE = '/^(?:[0-9]{1,3}\.){3}[0-9]{1,3}$/';
    public const IPV6_RE = '/([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|
                    ...
                    . |1{0,1}[0-9]){0,1}[0-9])/';
    public const TEMPLATE_ESCAPE_RE = '/{\{\s*(.*?)\s*\}\}/';
    public const TEMPLATE_SEARCH_RE = '/\{[a-zA-Z#]+\}/';
    public const TEMPLATE_PARSE_RE = '#\{((?>[^\{\}]+)|(?R))*\}#x';
    public const HOST_LABEL_RE = '/^(?!-)[a-zA-Z\d-]{1,63}(?<!-)$/';
