...
class S3EndpointMiddleware
{
    ...
    public const NO_PATTERN = 0;
    public const DUALSTACK = 1;
    public const ACCELERATE = 2;
    public const ACCELERATE_DUALSTACK = 3;
    public const PATH_STYLE = 4;
    public const HOST_STYLE = 5;
