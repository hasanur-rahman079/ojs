...
{
    public const ENV_ENDPOINTS_TYPE = 'AWS_S3_US_EAST_1_REGIONAL_ENDPOINT';
    public const INI_ENDPOINTS_TYPE = 's3_us_east_1_regional_endpoint';
    public const DEFAULT_ENDPOINTS_TYPE = 'legacy';
