...
class RateLimiter
{
    ...
    public function __construct($options = [])
    {
        $this->beta = $options['beta']
            ?? 0.7;
        $this->minCapacity = $options['min_capacity']
            ?? 1;
        $this->minFillRate = $options['min_fill_rate']
            ?? 0.5;
        $this->scaleConstant = $options['scale_constant']
            ?? 0.4;
        $this->smooth = $options['smooth']
            ?? 0.8;
        $this->timeProvider = $options['time_provider']
            ?? null;
