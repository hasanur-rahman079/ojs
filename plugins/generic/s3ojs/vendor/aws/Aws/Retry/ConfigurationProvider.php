...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public const DEFAULT_MODE = 'legacy';
    public const ENV_MAX_ATTEMPTS = 'AWS_MAX_ATTEMPTS';
    public const ENV_MODE = 'AWS_RETRY_MODE';
    public const ENV_PROFILE = 'AWS_PROFILE';
    public const INI_MAX_ATTEMPTS = 'max_attempts';
    public const INI_MODE = 'retry_mode';
    ...
    public static function ini(
        ...
        return function () use ($profile, $filename) {
            ...
            $maxAttempts = $data[$profile][self::INI_MAX_ATTEMPTS]
                ?? self::DEFAULT_MAX_ATTEMPTS;
